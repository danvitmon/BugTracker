...
public static class DataUtility
{
  ...
  public static async Task SeedDefaultCompaniesAsync(ApplicationDbContext context)
  {
    try
    {
      IList<Company> defaultcompanies = new List<Company>
      {
        ...
        new() { Name = "Company3", Description = "This is default Company 3" },
        new() { Name = "Company4", Description = "This is default Company 4" },
        new() { Name = "Company5", Description = "This is default Company 5" }
      };
  ...
  public static async Task SeedDefaultProjectPrioritiesAsync(ApplicationDbContext context)
  {
    try
    {
      ...
      {
        new() { Name = nameof(BTProjectPriorities.Low) },
        new() { Name = nameof(BTProjectPriorities.Medium) },
        new() { Name = nameof(BTProjectPriorities.High) },
        new() { Name = nameof(BTProjectPriorities.Urgent) }
      };
  ...
  public static async Task SeedDefaultProjectsAsync(ApplicationDbContext context)
  {
    ...
    var priorityLow = context.ProjectPriorities.FirstOrDefault(p => p.Name == nameof(BTProjectPriorities.Low))!.Id;
    var priorityMedium =
      context.ProjectPriorities.FirstOrDefault(p => p.Name == nameof(BTProjectPriorities.Medium))!.Id;
    var priorityHigh = context.ProjectPriorities.FirstOrDefault(p => p.Name == nameof(BTProjectPriorities.High))!.Id;
    var priorityUrgent =
      context.ProjectPriorities.FirstOrDefault(p => p.Name == nameof(BTProjectPriorities.Urgent))!.Id;
  ...
  public static async Task SeedDefaultTicketStatusesAsync(ApplicationDbContext context)
  {
    try
    {
      ...
      {
        new() { Name = nameof(BTTicketStatuses.New) }, // Newly Created ticket having never been assigned
        new() { Name = nameof(BTTicketStatuses.Development) }, // Ticket is assigned and currently being worked 
        new() { Name = nameof(BTTicketStatuses.Testing) }, // Ticket is assigned and is currently being tested
        new()
        {
          Name = nameof(BTTicketStatuses.Resolved)
  ...
  public static async Task SeedDefaultTicketPrioritiesAsync(ApplicationDbContext context)
  {
    try
    {
      ...
      {
        new() { Name = nameof(BTTicketPriorities.Low) },
        new() { Name = nameof(BTTicketPriorities.Medium) },
        new() { Name = nameof(BTTicketPriorities.High) },
        new() { Name = nameof(BTTicketPriorities.Urgent) }
      };
  ...
  {
    //Get ticket type Ids
    var typeNewDev = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.NewDevelopment))!.Id;
    var typeWorkTask = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.WorkTask))!.Id;
    var typeDefect = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.Defect))!.Id;
    var typeEnhancement = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.Enhancement))!.Id;
    var typeChangeRequest = context.TicketTypes.FirstOrDefault(p => p.Name == nameof(BTTicketTypes.ChangeRequest))!.Id;

    //Get ticket priority Ids
    var priorityLow = context.TicketPriorities.FirstOrDefault(p => p.Name == nameof(BTTicketPriorities.Low))!.Id;
    var priorityMedium = context.TicketPriorities.FirstOrDefault(p => p.Name == nameof(BTTicketPriorities.Medium))!.Id;
    var priorityHigh = context.TicketPriorities.FirstOrDefault(p => p.Name == nameof(BTTicketPriorities.High))!.Id;
    var priorityUrgent = context.TicketPriorities.FirstOrDefault(p => p.Name == nameof(BTTicketPriorities.Urgent))!.Id;

    //Get ticket status Ids
    var statusNew = context.TicketStatuses.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.New))!.Id;
    var statusDev = context.TicketStatuses.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Development))!.Id;
    var statusTest = context.TicketStatuses.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Testing))!.Id;
    var statusResolved = context.TicketStatuses.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Resolved))!.Id;

    //Get admin Ids
    var company1AdminId = (await userManager.FindByEmailAsync("btadmin1@bugtracker.com"))!.Id;
    var company2AdminId = (await userManager.FindByEmailAsync("btadmin2@bugtracker.com"))!.Id;
    ...
    try
    {
      IList<Ticket> tickets = new List<Ticket>
      {
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 1",
          Description = "Ticket details for portfolio ticket 1",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 2",
          Description = "Ticket details for portfolio ticket 2",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 3",
          Description = "Ticket details for portfolio ticket 3",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 4",
          Description = "Ticket details for portfolio ticket 4",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 5",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 6",
          Description = "Ticket details for portfolio ticket 6",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 7",
          Description = "Ticket details for portfolio ticket 7",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Portfolio Ticket 8",
          Description = "Ticket details for portfolio ticket 8",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = portfolioId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect
        },
        //BLOG
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 1", Description = "Ticket details for blog ticket 1",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 2", Description = "Ticket details for blog ticket 2",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusDev, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 3", Description = "Ticket details for blog ticket 3",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 4", Description = "Ticket details for blog ticket 4",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 5", Description = "Ticket details for blog ticket 5",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityLow, TicketStatusId = statusDev, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 6", Description = "Ticket details for blog ticket 6",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 7", Description = "Ticket details for blog ticket 7",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 8", Description = "Ticket details for blog ticket 8",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusDev, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 9", Description = "Ticket details for blog ticket 9",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 10",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 11",
          Description = "Ticket details for blog ticket 11",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 12",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 13",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 14",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 15",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 16",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "Blog Ticket 17",
          Description = "Ticket details for blog ticket 17",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = blogId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeNewDev
        },
        //BUGTRACKER                                                                                                                         
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 1",
          Description = "Ticket details for bug tracker ticket 1",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = bugTrackerId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 2",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 3",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 4",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 5",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 6",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 7",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 8",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 9",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 10",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 11",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 12",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 13",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 14",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 15",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 16",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 17",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 18",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 19",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 20",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 21",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 22",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 23",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 24",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 25",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 26",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 27",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 28",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 29",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Bug Tracker Ticket 30",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 1",
          Description = "Ticket details for movie ticket 1",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = movieId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 2",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 3",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 4",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 5",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 6",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 7",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 8",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 9",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 10",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 11",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 12",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 13",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 14",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 15",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 16",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 17",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 18",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 19",
        ...
        new()
        {
          SubmitterUserId = company1AdminId, Title = "Movie Ticket 20",
        ...
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 1",
          Description = "Ticket details for addressbook ticket 1",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 2",
          Description = "Ticket details for addressbook ticket 2",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 3",
          Description = "Ticket details for addressbook ticket 3",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 4",
          Description = "Ticket details for addressbook ticket 4",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 5",
          Description = "Ticket details for addressbook ticket 5",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 6",
          Description = "Ticket details for addressbook ticket 6",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 7",
          Description = "Ticket details for addressbook ticket 7",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement
        },
        new()
        {
          SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 8",
          Description = "Ticket details for addressbook ticket 8",
          Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressBookId,
          TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect
        }
      };
