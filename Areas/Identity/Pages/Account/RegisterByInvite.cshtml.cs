...
public class RegisterByInviteModel : PageModel
{
  ...
  public async Task OnGetAsync(string token, int companyId, int id, string returnUrl = null)
  {
    ...
    var invite = await _inviteService.GetInviteAsync(id, companyId);
  ...
  public async Task<IActionResult> OnPostAsync(string returnUrl = null)
  {
    ...
    var invite = await _inviteService.GetInviteAsync(Guid.Parse(Input.Token), Input.Email, Input.CompanyId);
